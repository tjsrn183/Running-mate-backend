...
class Run extends sequelize_1.Model {
    static initiate(sequelize) {
        Run.init({
            ...
            startLocationNuturalLan: { type: sequelize_1.default.STRING, allowNull: false },
            endLocationNuturalLat: { type: sequelize_1.default.STRING, allowNull: false },
            ...
            body: { type: sequelize_1.default.STRING, allowNull: false },
            numOfPeople: { type: sequelize_1.default.INTEGER, allowNull: false },
            createAt: { type: sequelize_1.default.DATE, allowNull: false },
            updateAt: { type: sequelize_1.default.DATE, allowNull: false },
        }, {
            sequelize,
            timestamps: false,
            underscored: false,
